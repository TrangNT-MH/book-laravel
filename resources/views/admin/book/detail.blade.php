                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="book-language" name="language"
                                           placeholder="Language" value="{{ old('language', $selectBook->language) }}"
                                           readonly>
...
{{--                                    @endif--}}
                                    <input type="text" class="form-control book-category" id="book-pages" name="category"
                                           placeholder="Category" value="{{ old('category', $selectBook->category) }}"
                                           readonly>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control book-pages" id="book-pages" name="page_count"
                                           placeholder="Pages" value="{{ old('page_count', $selectBook->page_count) }}"
                                           readonly>
                                    @if($errors->has('language'))
                                        <span class="text-danger">{{ $errors->first('language') }}</span>
                                    @endif
